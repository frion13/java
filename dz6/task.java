...
public class task {
   public static void main(String[] args) {
      Notebook notebook1 = new Notebook("Apple", "8", "1000", "Windows", "grey");
      Notebook notebook2 = new Notebook("Asus", "4", "1000", "Lunex", "black");
      Notebook notebook3 = new Notebook("Asus", "8", "2000", "Windows", "black");
   ...
   public static Map<String, String> selectCriteria() {
      ...
      while (true) {
         System.out.println("Введите ведите 'y' для выбора критерия, для выхода нажмите 'n'");
